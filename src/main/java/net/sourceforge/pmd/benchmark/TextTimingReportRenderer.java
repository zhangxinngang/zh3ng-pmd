...
public class TextTimingReportRenderer implements TimingReportRenderer {
    ...
    private void renderCategoryMeasurements(final TimedOperationCategory category,
        ...
        final TreeSet<Entry<String, TimedResult>> sortedKeySet = new TreeSet<>(
            new Comparator<Entry<String, TimedResult>>() {
                @Override
        ...
        for (final Entry<String, TimedResult> entry : sortedKeySet) {
