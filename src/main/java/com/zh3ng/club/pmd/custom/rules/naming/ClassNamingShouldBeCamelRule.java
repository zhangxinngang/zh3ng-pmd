...
public class ClassNamingShouldBeCamelRule extends AbstractAliRule {
    ...
    private static final Pattern PATTERN
        = Pattern.compile("^[IT]?([A-Z][a-z0-9]+)+(([A-Z])|(DO|DTO|VO|DAO|BO|DAOImpl|YunOS|AO|PO|POExample|POMapper))?$");

    private static final List<String> CLASS_NAMING_WHITE_LIST = NameListConfig.NAME_LIST_SERVICE.getNameList(
        com.alibaba.p3c.pmd.lang.java.rule.naming.ClassNamingShouldBeCamelRule.class.getSimpleName(), "CLASS_NAMING_WHITE_LIST");
